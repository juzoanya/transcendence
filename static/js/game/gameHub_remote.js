import { msg_to_worker_remote } from './game_worker_remote_messages.js';
import { pongMessageTypes } from './game_worker_remote_messages.js';
 ...
 * @property {import('./game_worker_remote_messages').GameSettings} [settings]
 */
...
export class GameHubRemote {
    ...
    static gamesWorker = {
        pong: "/static/js/game/worker_remote.js",
        other: "/static/js/game/worker_remote.js"
    }
     ...
     * @param {string} game 
     * @param {import('./types.js').GameScheduleItem} gameData
     * @param {import('./game_worker_remote_messages').GameSettings} gameSettings
     */
    ...
    constructor(game, canvas, gameData, gameSettings) {
        ...
        try {
            this.#gamesocket = new WebSocket(`ws://localhost:8000/ws/game/${this.gameData.schedule_id}/`);
        ...
        this.#gamesocket.addEventListener("open", function(e){
        ...
        if (this.#gamesocket) {
            ...
            this.#gamesocket.onmessage = (e) => {
                ...
                /** @type {import('./types_game.js').PongMessage} */
    ...
    /** @param {import('./types_game.js').StartGameData | null} startData */
    initGame(startData) {
