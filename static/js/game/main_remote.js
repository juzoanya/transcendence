...
export class DrawObjRemote {
    ...
    constructor(w, h, settings) {
        ...
        this.dx = 0;
        this.dy = 0;
        /** @type {import('./types_game.js').GameSettings} */
    ...
    /**
     * @param {import('./types_game.js').GameObj} gameObj
     */
    updatePos(gameObj) {
...
export class PongRemote {
    /** @param {import('./game_worker_remote_messages.js').WorkerDataInit} d */
    constructor(d) {
    ...
    /**
     * @param {import('./types_game.js').GameSettings} gameSettings
     */
    ...
    /**
     * @param {import('./types_game.js').GameState} gamestate
     */
    ...
    /** @param {import('./game_worker_remote_messages.js').WorkerDataChangeColors} d */
    changeColor(d) {
    ...
    /** @param {import('./game_worker_remote_messages.js').WorkerDataResize} d */
    setCanvasSizes(d) {
        if (!this.ctx) return ;
        this.width = d.width;
